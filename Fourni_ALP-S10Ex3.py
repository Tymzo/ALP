...
def main():
    ...
    if no_course == 1:
        lst_temps = [12.5,12.7,12.8,13.2,13.7,15.1,15.8,15.8,16.2,19.7]
        lst_genre = [True,True,True,False,True,True,False,False,True,True]
    elif no_course == 2:
        lst_temps = [22.5,22.7,22.8,23.2,23.7,25.1,25.8,25.8,26.2,29.7]
        lst_genre = [False,True,False,True,True,True,False,False,True,True]
    elif no_course == 3:
        lst_temps = [32.5,32.7,32.8,33.2,33.7,35.1,35.8,35.8,36.2,39.7]
        lst_genre = [True,True,True,True,True,True,True,True,True,True]
    elif no_course == 4:
        lst_temps = [42.5,42.7,40.8,43.2,43.7,45.2,45.1,45.8,45.8,49.7]
        lst_genre = [True,True,False,True,True,True,False,False,True,True]
    else:
